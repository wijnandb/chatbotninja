"""
Django settings for Botminds project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-vs1S7UKkBjZSfc8BgnSV1Gi8oFPvPfW0Oq5aUaiP")
...
WSGI_APPLICATION = "botminds.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="botminds"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "botminds_language"
...
SERVER_EMAIL = env("SERVER_EMAIL", default="noreply@127.0.0.1:8000")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Botminds",
    "DESCRIPTION": "This is the repo in which I will try to get Scriv working",  # noqa: E501
    "VERSION": "0.1.0",
...
WAGTAIL_SITE_NAME = "Botminds Content"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Botminds"),
    "URL": "http://127.0.0.1:8000",
    "DESCRIPTION": gettext_lazy("This is the repo in which I will try to get Scriv working"),  # noqa: E501
...
LOGGING = {
    ...
    "loggers": {
        ...
        "botminds": {
            "handlers": ["console"],
            "level": env("BOTMINDS_LOG_LEVEL", default="INFO"),
        },
    },
}
