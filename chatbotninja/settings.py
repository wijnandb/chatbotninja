"""
Django settings for Chatbotninja project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-CAXvvSH59EZoRoEyd9mpEvsTjSrrn9q78TJGVszB")
...
ROOT_URLCONF = "chatbotninja.urls"
...
WSGI_APPLICATION = "chatbotninja.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="chatbotninja"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "chatbotninja_language"
LANGUAGES = [
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="chatbotninja-media")
...
EMAIL_SUBJECT_PREFIX = "[Chatbotninja] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Chatbotninja",
    "DESCRIPTION": "Custom chatbots. Chat with your own data.",  # noqa: E501
    "VERSION": "0.1.0",
...
ASGI_APPLICATION = "chatbotninja.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Chatbotninja"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Custom chatbots. Chat with your own data."),  # noqa: E501
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "wijnand@baretta.nl",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = [("Wijnand", "wijnand@baretta.nl")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "chatbotninja": {
            "handlers": ["console"],
            "level": env("CHATBOTNINJA_LOG_LEVEL", default="INFO"),
        },
    },
}
